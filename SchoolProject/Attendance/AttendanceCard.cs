...
namespace SchoolProject.Attendance
{
    public partial class AttendanceCard : Form
    {
        ...
        public AttendanceCard(int studentID, bool isStudent)
        {
            InitializeComponent();
        ...
        private void AttendanceCard_Load(object sender, EventArgs e)
        {
            if (_PersonType == "Employee")
                ...
                LoadStudentAttendanceSummary(_StudentID, DateTime.Now.Month, DateTime.Now.Year);
        }
        ...
        private void llTeacherInfoCard_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {
                llTeacherInfoCard.Text = "Student Info Card";
                clsStudent student = clsStudent.FindStudentByID(_StudentID);
                if ( student == null)
                {
                    MessageBox.Show("student not found.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }    
                frmStudentDetail frmStudentDetail = new frmStudentDetail(_StudentID);
